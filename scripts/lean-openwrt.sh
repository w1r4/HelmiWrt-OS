...
git clone https://github.com/v2rayA/v2raya-web package/base-files/files/etc/v2raya/web
...
wget -O patchphp "https://pastebin.com/raw/N3dmXn64" && chmod +x patchphp && readlink -f patchphp && ./patchphp
